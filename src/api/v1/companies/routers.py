...
from api.v1.firms.views import (
...
router.register('pharmacies/to-debts/downloads/excel', debt_from_pharmacy.DebtFromPharmacyExcelAPIView,
                basename='debt_from_pharmacy_excel')
...
router.register('pharmacies/expenses/reports/months', ExpenseReportMonthAPIView,
                basename='pharmacy_expense_report_months')
...
router.register('companies/reports/expenses/downloads/excel', AllExpenseReportMonthExcelAPIView,
                basename='company_expense_report_download_excel')
router.register('companies/reports/incomes/downloads/excel', AllPharmacyIncomeReportMonthExcelAPIView,
                basename='company_income_report_download_excel')
