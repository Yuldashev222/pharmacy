# Generated by Django 4.2 on 2023-05-06 13:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='from_user_expenses', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pharmacy_expense', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='pharmacy_expenses_history', to='expenses.expense')),
            ],
            options={
                'abstract': False,
            },
