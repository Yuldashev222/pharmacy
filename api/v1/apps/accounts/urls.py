...
urlpatterns = [
    ...
    path('directors/<int:pk>/update/', views.DirectorUpdateDestroyAPIView.as_view()),
    path('managers/<int:pk>/update/', views.ManagerUpdateDestroyAPIView.as_view()),
    path('workers/<int:pk>/update/', views.WorkerUpdateDestroyAPIView.as_view()),
